...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-end">
                ...
                <li class="breadcrumb-item active" aria-current="page"><button class="btn btn-sm btn-outline-primary"
                    data-bs-toggle="modal" data-bs-target="#mantenedorAgregar">
                    Agregar +
                  </button></li>
              </ol>
            </div>
  ...
  <!--end::App Content-->
  <!-- Modal -->
    <div class="modal fade" id="mantenedorAgregar" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
          ...
          <form action="./add/" method="post">
            <div class="modal-body">
              ...
              <div class="form-floating">
                ...
                <label for="password22">Vuelva a ingresar su contraseña</label>
              </div>
              <div class="form-floating">
    ...
    <label for="floatingSelect">Seleccione el tipo de rol</label>
  </div>
            </div>
